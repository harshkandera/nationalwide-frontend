        ...
        <section className="py-12 bg-white sm:py-16 font-inter lg:py-20">
            <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
                <div className="text-center">
                    <h2 className="text-3xl font-bold leading-tight text-gray-900 sm:text-4xl xl:text-5xl font-pj">Why Work with nationwide-motors.com </h2>
                ...
                <div className="grid grid-cols-1 mt-10 text-center sm:mt-16 sm:grid-cols-2 sm:gap-x-12 gap-y-12  md:gap-0 xl:mt-24">
                    ...
                    <div className="md:p-8 lg:p-14 md:border md:border-gray-200">
                        ...
                        <p className="mt-5 text-base text-gray-600 font-pj">Whether you’re looking for a single vehicle or buying in bulk, nationwide-motors.com offers flexible buying solutions to fit your needs. Our platform caters to businesses and individuals alike, making it the perfect choice for any scale of purchase.</p>
                    </div>
