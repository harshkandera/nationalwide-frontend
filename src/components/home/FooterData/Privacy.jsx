            ...
            <div className="max-w-5xl px-4 mx-auto sm:px-6 lg:px-8">
                ...
                <div className="max-w-2xl mx-auto text-center">
                    <h2 className="text-3xl font-bold leading-tight text-richblue-200 sm:text-4xl lg:text-5xl">
                        nationwide-motors Privacy Policy
                    </h2>
                ...
                <p className="mb-4">
                    nationwide-motors is committed to taking all reasonable and appropriate measures to safeguard the personal data that we hold from loss, misuse, or unauthorized
