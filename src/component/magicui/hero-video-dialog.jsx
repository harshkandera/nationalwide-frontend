    ...
    (<div className={cn("relative", className)}>
      <div
        ...
        <img
          ...
          width={1920}
          height={1080}
          className="w-full rounded-md border shadow-sm transition-all duration-200 ease-out group-hover:brightness-[0.8]" />
        <div
          ...
          <motion.div
            ...
            <motion.div
              ...
              <div
                ...
                <iframe
                  src={videoSrc}
                  className="size-full w-full h-[70vh] rounded-2xl"
                  allowFullScreen
